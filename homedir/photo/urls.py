...
from .views import PhotoCreate, PhotoLike, PhotoList, PhotoDelete, PhotoDetail, PhotoMyList, PhotoUpdate, PhotoCreate, PhotoFavorite, PhotoLikeList, PhotoFavoriteList, PhotoMyList
